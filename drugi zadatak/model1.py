...
def main():
    ...
    #training
    mcp_save = ModelCheckpoint('weights/best_val_loss_model1.h5', save_best_only=True, monitor='val_loss', mode='min')
    ...
    #load best model
    model.load_weights('weights/best_val_loss_model1.h5')
