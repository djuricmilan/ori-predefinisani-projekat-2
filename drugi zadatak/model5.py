...
from tensorflow.keras.layers import Dense, LeakyReLU, Flatten, Conv2D, MaxPooling2D, BatchNormalization, Softmax, \
...
def main():
    ...
    # training
    mcp_save = ModelCheckpoint('weights/best_val_loss_model5.h5', save_best_only=True, monitor='val_loss', mode='min')
    ...
    # load best model
    model.load_weights('weights/best_val_loss_model5.h5')
